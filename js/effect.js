...
let strings = {
	'hu' : {
		'home_title': 'Xavier Rivadeneira operaénekes',
		...
		'your_name': '<input type="text" id="name" name="name" placeholder="Az Ön neve" maxlength="60" value="" >',
		'message': '<textarea id="message" name="message" rows="6" cols="50" placeholder="Üzenet" ></textarea>',
		'send': '<button type="submit" name="send">Elküld</button>',
		'your_email': '<input type="text" id="email" name="email" placeholder="E-mail címe" maxlength="60" value="" >',
	...
	'en' : {
		'home_title': 'Operatic Tenor Xavier Rivadeneira',
		...
		'message': '<textarea id="message" name="message" rows="6" cols="50" placeholder="Message" ></textarea>',
		'send': '<button type="submit" name="send">Send</button>',
		'your_email': '<input type="text" id="email" name="email" placeholder="Your e-mail" maxlength="60" value="" >',
		'your_name': '<input type="text" id="name" name="name" placeholder="Your name" maxlength="60" value="" >',
	...
	'es' : {
		'home_title': 'Página WEB de Xavier Rivadeneira',
		...
		'message': '<textarea id="message" name="message" rows="6" cols="50" placeholder="Mensaje" ></textarea>',
		'send': '<button type="submit" name="send">Enviar</button>',
		'your_email': '<input type="text" id="email" name="email" placeholder="Su direccion E-mail" maxlength="60" value="" >',
		'your_name': '<input type="text" id="name" name="name" placeholder="Su nombre" maxlength="60" value="" >',
